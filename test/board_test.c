...
CTEST(arithmetic_suite, geometry_triangle_perimeter) {
  ...
  // When
  double exp += sqrt(SQR(objectA->coordinates[0] - objectA->coordinates[2]) +
                     SQR(objectA->coordinates[1] - objectA->coordinates[3]));
  exp += sqrt(SQR(objectA->coordinates[0] - objectA->coordinates[4]) +
              SQR(objectA->coordinates[1] - objectA->coordinates[5]));
  exp += sqrt(SQR(objectA->coordinates[2] - objectA->coordinates[4]) +
